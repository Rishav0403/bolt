/**
 * Demo file tree and contents for browser preview mode
 * (when the Wails backend isn't available).
 *
 * Extracted from FileExplorer.jsx to keep the component focused on logic.
 */
